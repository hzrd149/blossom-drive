<script lang="ts">
  ...
  import { ExclamationCircleOutline, FileSolid } from "flowbite-svelte-icons";
  import { Name } from "@nostr-dev-kit/ndk-svelte-components";
  import { Button, DarkMode, Avatar, Search, Dropdown, DropdownItem, SidebarBrand, Alert } from "flowbite-svelte";
  ...
  const showMaintenanceBanner = writable(true);
</script>

<header
  id="topnav"
  class="relative z-20 flex flex-wrap items-center justify-between bg-gray-50 p-2 text-gray-700 dark:bg-gray-800 dark:text-gray-200"
>
  ...
  {#if $activeUser}
    <div class="hidden max-w-lg flex-1 flex-col lg:flex">
